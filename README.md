...
|------|---|---|---|
|황해진|방승욱|윤영아|서진형|
|-팀장<br>-프론트앤드<br>(세대별 메인 화면, 게시판 리스트 보기)<br>-백앤드 보조<br>(이미지 업로드, 공유, 가입, 로그인)<br>S3,RDS,EC2 연결 및 배포|-팀원<br>-프론트앤드<br>(투표 작성, 조회, 게시글 조회)|-팀원<br>-백앤드<br>(사진첩·일반게시판기능 구현)|-팀원<br>-백앤드<br>(멤버·투표 기능 구현)|
