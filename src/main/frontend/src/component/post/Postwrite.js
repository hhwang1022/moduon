...
const Postwrite = ({ generation, successhandler }) => {
  ...
  formData.append('imageDto', JSON.stringify({
    id: 1,
    category: "1020",
    boardtype: "hpoto"
  }));

  formData.append('multipartFile', uplodfile);
  ...
  return (<div className={"postwritemain" + generation}>
    ...
    <div>
      ...
      {
        uplodfile !== null ? <span>{uplodfile.name}<button className={'postuploadbtn' + generation} onClick={handlePostimg
